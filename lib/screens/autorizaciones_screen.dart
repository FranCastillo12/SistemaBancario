...
Widget _crearDropdown(String placeholder,List<String> dataList){
  ...
  Future<void> registrarProducto() async {
    if(_valueDrop.isEmpty ||_entidadDestinoController.text.isEmpty ||_clienteAutorizaController.text.isEmpty
    ||_fechaInicioController.text.isEmpty || _fechaFinalizacionController.text.isEmpty){
    ...
    String entidadDestino = _entidadDestinoController.text.substring(2, 5);
    ...
    autorizacion
      ...
      ..identificacionOrigen = '117010442' //Cambiar por la persona que esta autentificada
